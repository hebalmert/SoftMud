...
public partial class FormContractor
{
    ...
    [Parameter, EditorRequired] public Contractor Contractor { get; set; } = null!;
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        if (IsEditControl)
        {
            ImageUrl = Contractor.ImageFullPath;
        }
    }
    ...
    private async Task LoadDocument()
    {
        ...
        if (IsEditControl)
        {
            SelectedDocument = DocumentTypes!.Where(x => x.CorporationId == Contractor.CorporationId)
    ...
    {
        Contractor.DocumentTypeId = modelo.DocumentTypeId;
        SelectedDocument = modelo;
    }

    private void ImageSelected(string imagenBase64)
    {
        Contractor.ImgBase64 = imagenBase64;
        ImageUrl = null;
    }
