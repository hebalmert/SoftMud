...
public partial class IndexControlContrato
{
    ...
    private async Task ShowModalAsync(Guid? id = null, bool isEdit = false)
    {
        ...
        if (isEdit)
        {
            ...
            dialog = await _dialogService.ShowAsync<EditContractClient>($"Editar Contrato", parameters, options);
        }
        else
        {
            dialog = await _dialogService.ShowAsync<CreateContractClient>($"Nuevo Contrato", options);
        }
