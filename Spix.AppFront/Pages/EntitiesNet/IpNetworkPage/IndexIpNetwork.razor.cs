...
public partial class IndexIpNetwork
{
    ...
    public List<IpNetwork>? IpNetworks { get; set; }
    ...
    private async Task ShowModalAsync(Guid? id = null, bool isEdit = false)
    {
        ...
        if (isEdit)
        {
            ...
            dialog = await _dialogService.ShowAsync<EditIpNetwork>($"Editar Ip", parameters, options);
        }
        else
        {
            dialog = await _dialogService.ShowAsync<CreateIpNetwork>($"Nueva Ip", options);
        }
