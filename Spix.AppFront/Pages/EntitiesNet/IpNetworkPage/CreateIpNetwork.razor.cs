...
public partial class CreateIpNetwork
{
    ...
    private IpNetwork IpNetwork = new();
    ...
    {
        IpNetwork.Active = true;
    }

    private async Task Create()
    {
        var responseHttp = await _repository.PostAsync($"{BaseUrl}", IpNetwork);
