...
public partial class IndexServer
{
    ...
    private async Task ShowModalAsync(Guid? id = null, bool isEdit = false)
    {
        ...
        if (isEdit)
        {
            ...
            dialog = await _dialogService.ShowAsync<EditServer>($"Editar Servidor", parameters, options);
        }
        else
        {
            dialog = await _dialogService.ShowAsync<CreateServer>($"Nuevo Servidor", options);
        }
