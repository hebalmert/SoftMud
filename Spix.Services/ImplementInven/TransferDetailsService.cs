...
public class TransferDetailsService : ITransferDetailsService
{
    ...
    public async Task<ActionResponse<IEnumerable<TransferDetails>>> GetAsync(PaginationDTO pagination, string email)
    {
        try
        {
    ...
    public async Task<ActionResponse<TransferDetails>> AddAsync(TransferDetails modelo, string email)
    {
        await _transactionManager.BeginTransactionAsync();
        try
        {
    ...
    public async Task<ActionResponse<Transfer>> CerrarTransAsync(Transfer modelo, string email)
    {
        await _transactionManager.BeginTransactionAsync();
        try
        {
