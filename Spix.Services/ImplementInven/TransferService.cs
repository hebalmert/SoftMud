...
public class TransferService : ITransferService
{
    ...
    public async Task<ActionResponse<IEnumerable<Transfer>>> GetAsync(PaginationDTO pagination, string email)
    {
        try
        {
    ...
    public async Task<ActionResponse<Transfer>> AddAsync(Transfer modelo, string email)
    {
        await _transactionManager.BeginTransactionAsync();
        try
        {
