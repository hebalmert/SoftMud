...
{
    /// <inheritdoc />
    public partial class ComprasStockAlmacen : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CorporationId = table.Column<int>(type: "int", nullable: false),
                    ProductStorageId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Purchases_ProductStorages_ProductStorageId1",
                        column: x => x.ProductStorageId1,
                        principalTable: "ProductStorages",
                        principalColumn: "ProductStorageId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseDetails_CorporationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Purchases_ProductStorageId1",
                table: "Purchases",
                column: "ProductStorageId1");
